...
- (void)setupAudioGraph
{
    ...
    self.ioUnit = [audioGraph addAudioUnitWithType:kAudioUnitType_Output subType:YASAudioUnitSubType_DefaultIO prepareBlock:^(YASAudioUnit *audioUnit) {
    ...
    self.mixerUnit = [audioGraph addAudioUnitWithType:kAudioUnitType_Mixer subType:kAudioUnitSubType_MultiChannelMixer prepareBlock:^(YASAudioUnit *audioUnit) {
        [audioUnit setMaximumFramesPerSlice:4096];
    }];
