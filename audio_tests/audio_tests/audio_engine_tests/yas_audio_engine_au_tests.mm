...
@interface yas_audio_au_tests : XCTestCase

@end

@implementation yas_audio_au_tests
...
- (void)test_restore_parameters {
    ...
    audio::engine::au delay_au(kAudioUnitType_Effect, kAudioUnitSubType_Delay);
    ...
    delay_au.manageable().reload_audio_unit();
