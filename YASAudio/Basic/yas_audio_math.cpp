...
template <>
Float64 audio_math::decibel_from_linear(const Float64 linear)
{
    return 20.0 * log10(linear);
}

template <>
Float32 audio_math::decibel_from_linear(const Float32 linear)
{
    return 20.0f * log10f(linear);
}

template <>
Float64 audio_math::linear_from_decibel(const Float64 decibel)
{
    return pow(10.0, decibel / 20.0);
}

template <>
Float32 audio_math::linear_from_decibel(const Float32 decibel)
{
    return powf(10.0f, decibel / 20.0f);
}

template <>
Float64 audio_math::tempo_from_seconds(const Float64 seconds)
{
...
Float64 audio_math::seconds_from_frames(const UInt32 frames, const Float64 sample_rate)
{
    return static_cast<Float64>(frames) / sample_rate;
}

UInt32 audio_math::frames_from_seconds(const Float64 seconds, const Float64 sample_rate)
{
