...
audio_enumerator::audio_enumerator(const audio_data_ptr &data, const UInt32 channel)
...
audio_frame_enumerator::audio_frame_enumerator(const audio_data_ptr &data)
    : _frame(0),
      _channel(0),
