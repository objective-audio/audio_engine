...
namespace yas
{
    namespace audio
    {
        ...
        CFStringRef to_file_type(const AudioFileTypeID fileTypeID);
        ...
        CFDictionaryRef wave_file_settings(const Float64 sample_rate, const UInt32 channel_count,
                                           const UInt32 bit_depth);
        CFDictionaryRef aiff_file_settings(const Float64 sample_rate, const UInt32 channel_count,
                                           const UInt32 bit_depth);
