...
audio_device_io_node::audio_device_io_node() : audio_device_io_node(audio::device(nullptr))
{
}
...
audio_device_io_node::audio_device_io_node(const audio::device &device)
...
void audio_device_io_node::set_device(const audio::device &device)
{
    impl_ptr<impl>()->set_device(device);
}

audio::device audio_device_io_node::device() const
{
