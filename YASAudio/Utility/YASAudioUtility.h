...
extern "C"
{
    ...
    extern AudioBufferList *YASAudioAllocateAudioBufferList(const UInt32 inBufferCount, const UInt32 inNumberChannels, const UInt32 inSize);
    extern AudioBufferList *YASAudioAllocateAudioBufferListWithoutData(const UInt32 inBufferCount, const UInt32 inNumberChannels);
    ...
    extern Boolean YASAudioCopyAudioBufferListFlexibly(const AudioBufferList *inFromList,
                                                       AudioBufferList *ioToList,
    ...
    extern Boolean YASAudioIsEqualASBD(const AudioStreamBasicDescription *inAsbd1, const AudioStreamBasicDescription *inAsbd2);
