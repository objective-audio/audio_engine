...
- (void)test_set_format_success
{
    ...
    format = yas::audio_format::create(48000.0, 2, yas::pcm_format::fixed824, false);
...
- (void)test_set_format_failed
{
    ...
    format = yas::audio_format::create(48000.0, 2, yas::pcm_format::float64, false);
    XCTAssertThrows(mixer_unit->set_output_format(format->stream_description(), 0));
    ...
    format = yas::audio_format::create(48000.0, 2, yas::pcm_format::int16, false);
    XCTAssertThrows(mixer_unit->set_output_format(format->stream_description(), 0));
    ...
    format = yas::audio_format::create(48000.0, 2, yas::pcm_format::float32, true);
    XCTAssertThrows(mixer_unit->set_output_format(format->stream_description(), 0));
