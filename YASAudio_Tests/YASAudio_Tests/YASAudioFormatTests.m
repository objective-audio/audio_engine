...
- (void)testEqualAudioFormats
{
    ...
    YASAudioFormat *audioFormat1 =
        [[YASAudioFormat alloc] initStandardFormatWithSampleRate:sampleRate channels:channelCount];
    YASAudioFormat *audioFormat1b = YASRetain(audioFormat1);
    YASAudioFormat *audioFormat2 =
        [[YASAudioFormat alloc] initStandardFormatWithSampleRate:sampleRate channels:channelCount];
...
- (void)testCreateAudioFormatWithSettings
{
    ...
    settings = [NSDictionary yas_linearPCMSettingsWithSampleRate:sampleRate
                                                numberOfChannels:2
                                                        bitDepth:32
                                                     isBigEndian:NO
                                                         isFloat:YES
