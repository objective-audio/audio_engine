...
audio::io_kernel::io_kernel(io_render_f const &render_handler, std::optional<audio::format> const &input_format,
...
audio::io_kernel_ptr audio::io_kernel::make_shared(io_render_f const &render_handler,
